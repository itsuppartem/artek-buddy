    ...
    *,
    ...
    if role == "lead":
        parts.append(
            ...
            "If the assignment is unclear or a required fact is missing, call ask_user before "
            "producing a result. Do not invent a target or pick a default silently. "
            "One question at a time; do not interview. Do not ask for passwords. "
        ...
        parts.append(
            ...
            "Do not close Chromium after one bad locator. "
            "If the assignment is unclear or a required fact is missing, call ask_user before "
            "producing a result. Do not invent a target. Finishing the wrong artifact is not success. "
            "One question at a time; do not interview. Do not ask for passwords. "
            "After the answer returns, continue this same worker. "
