...
| In `please e2e-worker-progress`, the compact summary shows **Working on this task** and one **Show work log** — not a second **Still working:** line. Header identity is **Working**, not the progress paragraph. Worker briefs are collapsed, scannable rows—not a full prompt wall—and detail is not duplicated as durable chat messages | [ ] | [ ] |
