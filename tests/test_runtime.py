...
class RuntimeOptionsTest(unittest.TestCase):
    ...
    def test_custom_tools_contains_remember(self) -> None:
        ...
        self.assertIn("read_owner_file", tools)
        self.assertIn("write_owner_file", tools)
        self.assertIn("list_owner_dir", tools)
        self.assertIn("run_owner_command", tools)
        self.assertIn("send_message", tools)
        self.assertIn("send_file", tools)
        ...
        self.assertIn("browser_act", tools)
        ...
        self.assertIn("send_file", runtime._custom_tools(role="subagent"))
